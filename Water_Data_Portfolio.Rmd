---
title: "Andre Dextre's Portfolio of Water Use"
author: "Andre Dextre"
date: "`r Sys.Date()`"
output:
...
### Step 3: Organize Data by Sector and FIPS (Federal Information Standards)
...
### Step 4: Combine Data and Organize For Plotting
...
ggplot() +
  ...
  labs(x = "Year",
       ...
       caption = "Figure 1: Total Fresh Withdrawals in the USA 1950-2015.(Plot created by A. Dextre. Data from USGS (2015)).") +
...
1.  Data are presented differently for 1985 and afterwards than prior to 1985. The reason for this is because we now have data by county rather than by state. I accounted for this by grouping the columns by "State", summarizing across the "state", "year", "agency", "scode", and "area" columns, and creating a "Year" column. I did this to merge the file columns under one state column, and since the "year" column was removed, I created a "Year" column with the corresponding year.

### Step 6: Organize Data For Plotting Timeseries of Sectoral Withdrawals
...
**Fresh Water Withdrawals Trends by Sector in the USA (1950-2015)**
...
### Step 7: Organize Data For Plotting Timeseries of Sectoral Withdrawals for Colorado
...
**Fresh Water Withdrawals by Sector in Colorado (1950-2015)**
...
cap <-c("Figure 4: Public supply by state. Data from USGS (2015). Created by Andre Dextre.",
        "Figure 5: Irrigation by state. Data from USGS (2015). Created by Andre Dextre.")
...
### Step 9: Organized Data for Plotting Timeseries of GW and SW Withdrawals for USA
...
ggplot() +
  ...
  labs(x = "Year",
       y = "Withdrawals (Mgal/day)\n",
       caption = "Figure 6: Trends in population and freshwater withdrawals by source in USA. Data from USGS (1965 - 2015)",
       fill = "") +
...
**Total Freshwater Withdrawals and Population Trends in the USA (1965-2015)**
From 1965 to 1980, there is a positive correlation between an increasing population and total freshwater
withdrawals. In 1985, total freshwater withdrawals started to decrease while population was still growing. Additionally, from 2005-2015, as population increased, total freshwater withdrawals decreased, this is likely due to more water conservation practices after the 1980s and water use reductions due to extreme drought in the American West.

### Step 10: Organize for Plotting Timeseries of GW and SW Withdrawals for Colorado
